...
<div className="flex flex-center gap-4 ml-4 ">
     <div className=" justify-end">{feature[i]}</div>
      <h5 className="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white">{el.categorieName}</h5></div>
       <input id="vue-checkbox-list" type="checkbox" className="w-8 h-8 ml-6 bg-gray-100 border-gray-300 rounded focus:ring-orange- dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"/>                                              
                                      </div>
                                )
                            })}
  </div> </div>    
